...
bool motion_capture_tracking_interfaces__msg__target_position__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("motion_capture_tracking_interfaces.msg._target_position.TargetPosition", full_classname_dest, 70) == 0);
  }
  motion_capture_tracking_interfaces__msg__TargetPosition * ros_message = _ros_message;
  {  // target_id
...
PyObject * motion_capture_tracking_interfaces__msg__target_position__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("motion_capture_tracking_interfaces.msg._target_position");
