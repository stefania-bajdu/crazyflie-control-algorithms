...
def main(args=None):
    ...
    try:
        ...
        # cfcontrol.save_data(f"src/Data_Drone/data_files/drone_data_{controller.simid}_spline.npy", controller.output_data, controller.ref, controller.vref)
        # cfcontrol.save_data(f"src/Data_Drone/data_files/drone_data_{controller.simid}_takeoff_spline.npy", controller.takeoff_data, controller.refto, controller.vrefto)
        # np.save(f"src/Data_Drone/data_files/computation_times_{controller.simid}_spline.npy", {"comp_times": controller.comp_times})
